function P = SimulateAVG(T1AMP3, T1AMP2, T1AMP1, T1OAP3, T1OAP2, T1OAP1, T2AMP3, T2AMP2, T2AMP1, T2OAP3, T2OAP2, T2OAP1, N)
    ...
    D1 = TwoSimulation(T1AVG3, T1AVG2, T1AVG1, T2AVG3, T2AVG2, T2AVG1, N);
    ...
    for i = 1:N
        while D1(i) == 0
            ...
            D1(i) = TwoSimulation(T1AVG3, T1AVG2, T1AVG1, T2AVG3, T2AVG2, T2AVG1, 1);
        end
        if any(D1(i) > 0)
            P1 = P1 + 1;
        end
